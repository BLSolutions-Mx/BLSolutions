                ...
                <AnimatePresence>
                  {dropdownOpen && (
                    <motion.div
                      ...
                      className="absolute left-1/2 top-full z-50 mt-4 w-64 -translate-x-1/2 overflow-hidden rounded-2xl border border-[rgba(94,104,120,0.14)] bg-white p-2 shadow-[0_20px_60px_rgba(32,47,76,0.18)]"
                    >
                      {serviceDropdownItems.map((dropdownItem) => {
                        ...
                        return (
                          ...
                          >
                            <div className="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-[#015095]/8">
              ...
              {mobileServicesOpen && (
                ...
                >
                  <div className="space-y-1 pb-2 pl-4">
                    <Link
                      to="/servicios"
                      className="flex items-center gap-3 rounded-xl px-4 py-3 text-xs font-bold uppercase tracking-[0.18em] text-[#015095] transition-all hover:bg-slate-100"
                    >
                      Ver todos
                    </Link>
                    {serviceDropdownItems.map((dropdownItem) => {
